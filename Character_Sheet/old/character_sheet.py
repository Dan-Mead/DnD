...
class CharacterSheet:
    ...
    def info_section(self, master_frame):
        ...
        info_frame_dict = {"Name": (0, char.info["name"], dict(font_mod=" 10 bold")),
                           "Race": (0, char.info["race_print"]),
                           "Level": (0, None),
                           "Alignment": (1, char.info["alignment"]),
                           "Size": (1, char.info["size"]),
                           "Speed": (1, char.info["speed"]),
                           "Faith": (1, char.info["faith"]),
                           "Skin": (2, char.info["skin colour"]),
                           "Hair": (2, char.info["hair colour"]),
                           "Eyes": (2, char.info["eye colour"]),
                           "Height": (2, char.info["height"]),
                           "Weight": (2, char.info["weight"]),
                           "Build": (2, char.info["build"]),
                           "Age": (2, char.info["age"]),
                           "Gender": (2, char.info["gender"]),
                           }
    ...
    def saves_section(self, master_frame):
        ...
        for n, attr in enumerate(glossary.attrs):
            ...
            cb = tk.Checkbutton(self.saves_frame,
                                variable=char.saving_throws[attr].prof,
                                text=attr,
                                font=default_font + " 10 bold")
            ...
            tk.Button(self.saves_frame,
                      textvariable=char.saving_throws[attr].mod,  # Must make save separate
                      relief=tk.FLAT,
                      borderwidth=2,
    ...
    def skills_section(self, master_frame):
        ...
        for n, skill in enumerate(skills.skills_list.values()):
            ...
            cb = tk.Checkbutton(self.skills_frame,
                                variable=char.skills[skill.name].prof,
                                textvariable=char.skills[skill.name].display,
                                font=default_font + " 10 bold",
                                anchor=tk.W
                                )
    ...
    def other_skills_section(self, master_frame):
        ...
        tk.Label(self.other_skills_frame,
                 textvariable=char.prof_bonus.mod,
        ...
        tk.Label(self.other_skills_frame,
                 textvariable=char.ability_scores["DEX"].mod,
        ...
        tk.Label(self.other_skills_frame,
                 textvariable=char.skills["passives"].perception.mod,
        ...
        tk.Label(self.other_skills_frame,
                 textvariable=char.skills["passives"].investigation.mod,
        ...
        tk.Label(self.other_skills_frame,
                 textvariable=char.skills["passives"].insight.mod,
    ...
    def health_section(self, master_frame):
        ...
        tk.Label(hp_frame,
                 textvariable=char.HP.current_hp,
...
def startup(load=None):
    ...
    if not load:
        ...
        filename = load
        if r"/base_characters/" in filename:
            type = "base_character"
        elif r"/active_characters/" in filename:
            type = "active_character"
